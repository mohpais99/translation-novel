                ...
                <div className="col-sm-12 col-md-9">
                    <div className="row">
                        <div className="col-sm-12 col-md-3 pl-4">
                            <img className="w-100" src={detail.image} alt="poster-image" style={{borderRadius: "11px"}} />
                            <div className="w-100 font-12 mt-3 px-1 d-inline-block">
                            ...
                            {/* <div className="w-100 mt-4 px-1 d-block">
                                <div className="h6 mb-1"><b>Tipe</b></div>
                                <Link to='/'>Web Novel (JP)</Link>
                            </div>
                            <div className="w-100 font-12 mt-3 px-1 d-inline-block">
